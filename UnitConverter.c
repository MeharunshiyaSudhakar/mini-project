...
float temp(void){
	...
	switch(CH){
		case 1:
			printf("Enter Temperature in Celsius : ") && scanf("%f",&m);
		...
		case 2:
			...
			break;
		case 3:
			printf("Enter Temperature in Fahrenheit : ") && scanf("%f",&m);
			printf("Temperature in Celsius : %f\n",0.5555555555555*(m-32));
			break;
		case 4:
			printf("Enter Temperature in Fahrenheit : ") && scanf("%f",&m);
			printf("Temperature in Kelvin : %f\n",0.5555555555555*(m-32)+273.15);
			break;
		case 5:
			printf("Enter Temperature in Kelvin : ") && scanf("%f",&m);
			printf("Temperature in Celsius : %f\n",m-273.15);
			break;
		case 6:
			printf("Enter Temperature in Kelvin : ") && scanf("%f",&m);
...
void dist(void){
    ...
    switch(CH){
		case 1:
			printf("Enter Distance in Kilometers : ") && scanf("%f",&m);
		...
		case 5:
			...
			break;
		case 6:
			printf("Enter Distance in Meters : ") && scanf("%f",&m);
		...
		case 10:
			...
			break;
		case 11:
			printf("Enter Distance in Centimeters : ") && scanf("%f",&m);
			printf("Distance in Kilometers : %f\n",m/100000);
			break;
		case 12:
			printf("Enter Distance in Centimeters : ") && scanf("%f",&m);
		...
		case 15:
			...
			break;
		case 16:
			printf("Enter Distance in Millimeters : ") && scanf("%f",&m);
			printf("Distance in Kilometers : %f\n",m/1000000);
			break;
		case 17:
			printf("Enter Distance in Millimeters : ") && scanf("%f",&m);
		...
		case 20:
			...
			break;
		case 21:
			printf("Enter Distance in Feet : ") && scanf("%f",&m);
			printf("Distance in Kilometers : %f\n",m*0.0003048);
			break;
		case 22:
			printf("Enter Distance in Feet : ") && scanf("%f",&m);
		...
		case 25:
			...
			break;
		case 26:
			printf("Enter Distance in Inches : ") && scanf("%f",&m);
			printf("Distance in Kilometers : %f\n",m*0.0254/1000);
			break;
		case 27:
			printf("Enter Distance in Inches : ") && scanf("%f",&m);
